...
export default {
  ...
  'API token for MinerU PDF conversion. Create it on the API Management page at mineru.net. When the cloud quota is unavailable, conversion automatically falls back to the locally-installed mineru CLI.': 'API token for MinerU PDF conversion. Create it on the API Management page at mineru.net. When the cloud quota is unavailable, conversion automatically falls back to the locally-installed mineru CLI.',
