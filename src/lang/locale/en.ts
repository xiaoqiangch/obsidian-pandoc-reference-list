...
export default {
  ...
  // Converter
  'Document Conversion Settings': 'Document Conversion Settings',
  'Conversion output path': 'Conversion output path',
  'Directory (relative to vault root) where converted markdown files and images will be saved.': 'Directory (relative to vault root) where converted markdown files and images will be saved.',
  'Conversion engine': 'Conversion engine',
  'MinerU (default) handles images, formulas, tables and references accurately. The LLM vision model is kept as a backup.': 'MinerU (default) handles images, formulas, tables and references accurately. The LLM vision model is kept as a backup.',
  'MinerU (Recommended, default)': 'MinerU (Recommended, default)',
  'LLM vision model (backup)': 'LLM vision model (backup)',
  'MinerU API Token': 'MinerU API Token',
  'API token for MinerU PDF conversion. Create it on the API Management page at mineru.net.': 'API token for MinerU PDF conversion. Create it on the API Management page at mineru.net.',
  'MinerU model version': 'MinerU model version',
  'MinerU model version. Defaults to "vlm" which handles formulas, tables, OCR and code well.': 'MinerU model version. Defaults to "vlm" which handles formulas, tables, OCR and code well.',
  'Conversion model API URL': 'Conversion model API URL',
  'OpenAI-compatible API URL for the LLM vision model (backup engine). Defaults to Volcengine ARK API.': 'OpenAI-compatible API URL for the LLM vision model (backup engine). Defaults to Volcengine ARK API.',
  'Conversion model API Key': 'Conversion model API Key',
  'API key for the LLM vision model (backup engine). Leave empty to use DeepSeek API Key.': 'API key for the LLM vision model (backup engine). Leave empty to use DeepSeek API Key.',
  'Conversion model name': 'Conversion model name',
  'Model name for the LLM vision model (backup engine). Supports any OpenAI-compatible vision model.': 'Model name for the LLM vision model (backup engine). Supports any OpenAI-compatible vision model.',
  ...
  'Force re-convert': 'Force re-convert',
  'Force re-convert started': 'Re-conversion started, previous output cleared.',
  'Conversion failed': 'Conversion failed',
  'No attachment found for conversion': 'No attachment found for conversion',
  'Please configure conversion model settings': 'Please configure conversion model settings',
  'Please configure the MinerU API token in settings': 'Please configure the MinerU API token in settings',
  'Resume conversion': 'Resume conversion',
  'Conversion resumed': 'Conversion resumed',
  'No converted markdown found': 'No converted markdown found',
  'Chapter': 'Chapter',
  'Library': 'Library',
  'Vault': 'Vault',
  'Switch search scope': 'Switch search scope',
  'Full-text hits': 'Full-text hits',
  'No full-text hits': 'No full-text hits',
  'No results found in vault.': 'No results found in vault.',
  'Open note': 'Open note',
  'Locate in PDF': 'Locate in PDF',
