...
export default {
  ...
  'OpenAI-compatible API URL for the vision model used to convert PDF/EPUB to Markdown. Defaults to Volcengine ARK API.': 'OpenAI-compatible API URL for the vision model used to convert PDF/EPUB to Markdown. Defaults to Volcengine ARK API.',
  'Conversion model API Key': 'Conversion model API Key',
  'API key for the conversion model. Leave empty to use DeepSeek API Key.': 'API key for the conversion model. Leave empty to use DeepSeek API Key.',
  'Conversion model name': 'Conversion model name',
  'Model name for the vision model (e.g., gpt-4o, claude-3-5-sonnet-20241022). Leave empty to use DeepSeek model.': 'Model name for the vision model. Defaults to doubao-seed-2-0-lite (Volcengine ARK). Supports any OpenAI-compatible vision model.',
